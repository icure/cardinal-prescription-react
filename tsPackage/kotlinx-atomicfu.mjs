...
protoOf(atomicfu$AtomicRefArray$ref).xl = function () {
  return this.wl_1.length;
};
protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
  return this.wl_1[index];
};
...
protoOf(AtomicRef).yl = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicRef).zl = function () {
...
protoOf(AtomicBoolean).am = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicBoolean).zl = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicLong).bm = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicLong).zl = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicInt).cm = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicInt).zl = function () {
  return this.kotlinx$atomicfu$value;
};
...
defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).xl);
//endregion
