...
import './index.css'
import { Duration, Medication, Medicinalproduct, Substanceproduct } from '@icure/be-fhc-api'
...
const Index: React.FC<Props> = ({ medicationToPrescribe, prescribedMedication, handleClose, handleSave, modalTitle }) => {
          ...
          >
            <div className="addMedicationForm__body__content">
              <div className="addMedicationForm__body__content__inputs">
                <Input label="Nom du médicament" value={medicationTitle} required disabled id="drugName" />
                ...
                <div className="addMedicationForm__body__content__inputs__group">
                  ...
                  />
                  <Select label="Unité de temps" id="durationTimeUnit" required options={durationTimeUnits} value={durationTimeUnit} onChange={setDurationTimeUnit} />
                </div>
                <div className="addMedicationForm__body__content__inputs__group">
                  <Input
                ...
                {!prescribedMedication && (
                  <div className="addMedicationForm__body__content__inputs__group">
                    ...
                    {prescriptionsNumber && prescriptionsNumber > 1 && (
                      <Select label="Périodicité" id="periodicityTimeUnit" required options={periodicityTimeUnits} value={periodicityTimeUnit} onChange={setPeriodicityTimeUnit} />
                    )}
            ...
            <Switch id="showExtraFields" value="Afficher plus" checked={showExtraFields} onChange={setShowExtraFields} />
            {!showExtraFields ? (
              ...
              <div className="addMedicationForm__body__content">
                <div className="addMedicationForm__body__content__inputs">
                  <Textarea label="Instructions pour le patient" id="recipeInstructionForPatient" value={recipeInstructionForPatient} onChange={setRecipeInstructionForPatient} />
                  <Select
